            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <input
                  ...
                  id="new-client-name"
                />
                <div className="p-[1px] rounded-lg bg-gradient-to-b from-indigo-300 to-indigo-800 shadow-sm transition-all duration-200 hover:shadow-md active:scale-[0.97] shrink-0">
                  <button
                    type="submit"
                    className="px-4 py-1.5 bg-gradient-to-b from-[#4f46e5] to-[#4338ca] text-white font-bold text-xs rounded-[7px] tracking-wide shadow-[inset_0_1px_0_rgba(255,255,255,0.3),inset_0_-1px_0_rgba(0,0,0,0.15)] hover:from-[#5c54f1] hover:to-[#4f46e5] transition-all cursor-pointer"
          ...
          <div className="bg-white p-6 border border-neutral-100 shadow-sm rounded-2xl space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="flex items-center gap-1.5 px-3.5 py-2 bg-neutral-50 hover:bg-neutral-100 border border-neutral-200 text-neutral-700 font-medium text-xs rounded-xl transition-colors cursor-pointer"
                id="export-data-btn"
              >
