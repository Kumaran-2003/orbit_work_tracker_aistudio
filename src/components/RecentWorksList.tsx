  ...
  return (
    <div className="space-y-4 font-sans">
      <div className="flex items-center justify-between pb-1">
        <h2 className="text-2xl font-medium text-[#cdddf0] tracking-tight">
          Recent Gigs
        </h2>
      </div>
      ...
      {sortedEntries.length === 0 ? (
        <div className="p-12 text-center bg-[#224044] border border-[#cdddf0]/15 rounded-[1.8rem] shadow-lg">
          ...
          <h4 className="text-sm font-medium text-[#cdddf0]/70 mb-4">No completed works logged yet</h4>
          <button
            onClick={onOpenAddForm}
            className="px-5 py-2.5 bg-[#38bdf8] hover:bg-[#7dd3fc] text-[#1c3538] rounded-full text-xs font-bold transition-all cursor-pointer shadow-md"
              ...
              >
                ...
                <div className="flex items-center gap-5 flex-1 min-w-0">
                  ...
                  <div className="space-y-1 flex-1 min-w-0">
                    ...
                    <p className="text-xs font-medium text-[#cdddf0]/60">
